  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="container mx-auto px-4 max-w-4xl py-20">
        <h1 className="text-6xl font-bold mb-16">Morocco Digital Skills Initiative: A Comprehensive National Digital Education Strategy</h1>
        ...
        <section className="mb-16">
          <div className="prose prose-lg">
            ...
            <h2 className="text-4xl font-semibold mb-8">The Challenge</h2>
            <p className="mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Current Market Statistics</h3>
            ...
            <h2 className="text-4xl font-semibold mb-8">The Solution: Morocco Digital Skills Initiative (MDSI)</h2>
            <p className="mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Core Components</h3>
            
            <h4 className="text-2xl font-semibold mb-4">Digital Learning Infrastructure</h4>
            <p className="mb-6">
            ...
            <h4 className="text-2xl font-semibold mb-4">Curriculum Design</h4>
            <p className="mb-6">
            ...
            <h4 className="text-2xl font-semibold mb-4">Industry Integration</h4>
            <p className="mb-6">
            ...
            <h2 className="text-4xl font-semibold mb-8">Detailed Implementation Strategy</h2>
            
            <h3 className="text-3xl font-semibold mb-4">Pre-Launch Phase (3-6 months)</h3>
            <h4 className="text-2xl font-semibold mb-4">Strategic Planning</h4>
            <p className="mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Phase 1: Foundation (Year 1)</h3>
            <h4 className="text-2xl font-semibold mb-4">Infrastructure Development</h4>
            <p className="mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Phase 2: Expansion (Years 2-3)</h3>
            <h4 className="text-2xl font-semibold mb-4">Regional Growth</h4>
            <p className="mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Phase 3: Nationwide Coverage (Years 4-5)</h3>
            <h4 className="text-2xl font-semibold mb-4">Full Scale Operations</h4>
            <p className="mb-6">
            ...
            <h2 className="text-4xl font-semibold mb-8">Investment Requirements</h2>
            
            <h3 className="text-3xl font-semibold mb-4">Infrastructure Costs</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Operational Costs (Annual)</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h2 className="text-4xl font-semibold mb-8">Expected Outcomes</h2>
            
            <h3 className="text-3xl font-semibold mb-4">Short-term (1-2 Years)</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Medium-term (3-5 Years)</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h2 className="text-4xl font-semibold mb-8">Economic Impact</h2>
            
            <h3 className="text-3xl font-semibold mb-4">Direct Benefits</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Indirect Benefits</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h2 className="text-4xl font-semibold mb-8">Risk Mitigation</h2>
            
            <h3 className="text-3xl font-semibold mb-4">Quality Control</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h3 className="text-3xl font-semibold mb-4">Market Alignment</h3>
            <ul className="list-disc pl-6 mb-6">
            ...
            <h2 className="text-4xl font-semibold mb-8">Call to Action</h2>
            <p className="mb-6">
