    ...
    <footer className="w-full bg-black py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
          ...
          <div>
            <img 
              src="/images/ma_acc.png" 
              alt="Moroccan Accelerationism" 
          ...
          <div className="flex items-center gap-6">
            {/* Discord */}
            <a 
              href="https://discord.gg/eWPPZK8aUZ" 
              target="_blank" 
            ...
            {/* Instagram */}
            <a 
              href="https://www.instagram.com/moroccan.accelerationism/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-white hover:text-gray-300 transition-colors"
            >
            ...
            {/* Reddit */}
            <a 
              href="https://www.reddit.com/r/ma_acc/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-white hover:text-gray-300 transition-colors"
            >
            ...
            {/* LinkedIn */}
            <a 
              href="https://www.linkedin.com/groups/13140099/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-white hover:text-gray-300 transition-colors"
            >
